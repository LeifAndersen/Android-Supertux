...
DrawingContext::do_drawing()
{
  ...
  //draw touch keys
  static SurfacePtr dirbuttons=Surface::create("images/directionbuttons.png");
  static SurfacePtr jumpactionbuttons=Surface::create("images/jumpactionbuttons.png");
  static int sfc_x=SCREEN_WIDTH-jumpactionbuttons->get_width();
  static int sfc_y=SCREEN_HEIGHT-jumpactionbuttons->get_height();
  
  draw_surface(dirbuttons,Vector(0,sfc_y),600);
  draw_surface(jumpactionbuttons,Vector(sfc_x,sfc_y),600);
